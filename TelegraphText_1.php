...
class TelegraphTextOne
{
     ...
     *
     * @param string $slug
     * @return TelegraphTextOne|null
     */
    public static function loadText(string $slug): ?TelegraphTextOne
    {
        ...
        $telegraphText = new TelegraphTextOne($data['title'], $data['text'], $data['author']);
...
$telegraph = new TelegraphTextOne($title, $text, $author);

$slug = $telegraph->storeText();

$loadedTelegraph = TelegraphTextOne::loadText($slug);
...
$loadedNewTelegraph = TelegraphTextOne::loadText($slug);
